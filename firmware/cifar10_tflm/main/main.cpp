...
constexpr char TAG[] = "cifar10_tflm";
...
void loadTestInput()
{
    for (
        int index = 0;
        index < cifar10::kInputElementCount;
        ++index
    )
    {
        inputTensor->data.int8[index] =
            g_cifar10_test_input[index];
    }
}
...
extern "C" void app_main()
{
    ESP_LOGI(
        TAG,
        "Starting CIFAR-10 TFLite Micro"
    );
